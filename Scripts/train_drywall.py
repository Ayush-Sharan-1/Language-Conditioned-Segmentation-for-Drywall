"""
Training script for language-conditioned drywall taping area segmentation.
"""
...
def validate(
    ...
    val_prompt = "segment drywall seam"
...
def cache_prompt_embeddings(
    ...
    all_prompts.add("segment drywall seam")
...
def main():
    parser = argparse.ArgumentParser(description="Train language-conditioned drywall taping area segmentation model")
    
    # Data paths
    parser.add_argument("--data_root", type=str, default="Dataset/drywall-post",
    ...
    run_name = f"drywall_attention_unet_v1_{timestamp}"
    ...
    for epoch in range(start_epoch, args.num_epochs):
        ...
        train_metrics, global_step = train_epoch(
            ...
            scaler, use_amp, class_name="taping_area"
        )
        ...
        if (epoch + 1) % args.val_every_n_epochs == 0:
            val_metrics = validate(
                ...
                prompt_embeddings_cache, use_amp, class_name="taping_area"
            )
